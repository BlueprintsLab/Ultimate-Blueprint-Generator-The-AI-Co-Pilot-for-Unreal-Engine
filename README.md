...
Discord Server: https://discord.gg/w65xMuxEhb

Roadmap & Changelog: https://trello.com/b/qmZ1t7vZ/ultimate-blueprint-generator

Documentation: https://docs.google.com/document/d/1ljFb3e7eKGW0rpxkya_uOX2hfWpWOWFnbXqsMC2vIw4/edit?usp=sharing
...
- Context-Aware Workflow: The AI is now aware of your context. It can create assets in your currently focused Content Browser folder and use actors selected in the level as spawn boundaries.
...
This tool was born from a simple idea: to break down the barriers between a creative vision and its technical implementation. It's the ultimate learning aid, the ultimate prototyper, and the ultimate time-saver. It's the tool we wish we had when we were starting out.

Why This is an Essential Investment in Your Workflow

💬 A True AI Partner, Not Just a Generator.

The conversation has changed. You can now select a node in your graph and ask the AI to add logic directly after it. It feels less like a command line and more like a collaboration. Got a confusing Blueprint from the marketplace? Just take a screenshot and ask the AI to explain it. It's a revolutionary way to learn and refactor code.
...
Your AI, your choice. We've massively expanded our support to include the most powerful models on the market. Use the creativity of Claude, the reliability of OpenAI, or the generous free tier of Google Gemini. (The results are the same among all AI Providers)

Coming Soon: The Future is Local. 
We are actively developing and testing Local LLM support via Ollama. This is our highest priority and will be coming in a future update, allowing for completely private, secure, and cost-free generation. Your purchase today guarantees you'll get this game-changing feature the moment it's ready.
